...
parser.add_argument('--root', default='/home/l/data_1/lzy/BraTSDataset/SplitBtraTS2018/Train', type=str)
parser.add_argument('--train_file', default='/home/l/data_1/lzy/BraTSDataset/SplitBtraTS2018/train.txt', type=str)
parser.add_argument('--dataname', default='BRATS2018', type=str)
parser.add_argument('--savepath', default='/home/l/data_2/lzy/SplitBra18/EATE-main/output', type=str)
parser.add_argument('--resume', default='/home/l/data_2/lzy/SplitBra18/EATE-main/output/model_1130.pth', type=str)
...
def main():
    ...
    for epoch in range(args.start_epoch, args.num_epochs):
        ...
        if (epoch+1) % 5 == 0 or (epoch>=(args.num_epochs-10)):
